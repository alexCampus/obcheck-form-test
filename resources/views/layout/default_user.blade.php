	...
	<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
		<div class="widget notif" id="widget_ma_page">
			...
			<img src="@if (Auth::user()->photo)
					    ...
					    @endif" class="img-responsive center-block" id="profil_modification" alt="Ma_photo">
			<span class="glyphicon glyphicon-pencil btn-default btn-xs fil_ariane" id="btn_modif_photo"><a href="/profil/{{ Auth::user()->pseudo }}/update" >modifier ma photo</a></span>

			<div class="pseudo_widget">
				<p> {{ Auth::user()->pseudo }}</p>
				<a class="btn btn-default btn-xs" id="btn_modif_info" href="/profil/{{ Auth::user()->pseudo }}/update">Modifier mes infos personnelles</a>
			</div>	
		</div>
	</div>
	<div class="col-lg-9 col-md-10 col-sm-10">
		<div class="row">
    		<div class="col-lg-offset-1 col-md-offset-2 col-sm-offset-3 col-lg-8 col-md-10 col-sm-11 col-xs-12">
